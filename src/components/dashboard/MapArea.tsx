...
const MapArea = () => {
  return (
    <div className="absolute inset-0 bg-background">
      {/* Placeholder — Cesium/Mapbox will mount here later */}
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-4">
        ...
        <div className="absolute bottom-4 left-4 flex items-center gap-3 text-[10px] font-mono text-muted-foreground/60">
