...
const RadarIndicator = ({ monitoredId }: RadarIndicatorProps) => {
  return (
    <div className="absolute top-4 right-4 z-10 animate-fade-in-up">
      <div className="flex items-center gap-3 px-3 py-2 rounded-lg bg-card/90 border border-phantom-green/20 backdrop-blur-sm glow-green">
        ...
        <span className="text-[10px] font-mono text-phantom-green tracking-wider uppercase">
