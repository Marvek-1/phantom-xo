...
import { neon as createClient } from '@neondatabase/serverless';
import type { Database } from './types';

const VITE_NEON_DATABASE_URL = import.meta.env.VITE_NEON_DATABASE_URL;
const VITE_NEON_API_KEY = import.meta.env.VITE_NEON_API_KEY;

// Import the supabase client like this:
// import { supabase } from "@/integrations/supabase/client";

export const neon = createClient(VITE_NEON_DATABASE_URL);
>>>>>>> Stashed changes
